...
namespace Booking.WebUI.Pages.Profile.Edit
{
    public class SecurityModel : PageModel
    {
        ...
        public SecurityModel(UserManager<Booking.Domain.Entities.User> userManager, SignInManager<Booking.Domain.Entities.User> signInManager)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "Twoje has³o zosta³o zaaktualizowane.";
